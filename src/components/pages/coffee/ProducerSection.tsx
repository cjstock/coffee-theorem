    ...
    return (
        <CoffeeSection title={title} description={description}>
            ...
            <InputText
                ...
                handleChange={e => dispatch({ type: "EditProducer", field: "name", payload: e.currentTarget.value })}
            />
            <InputText
                title="Website"
                id="producerUrl"
                ...
                handleChange={e => dispatch({ type: "EditProducer", field: "url", payload: e.currentTarget.value })}
            />
            <InputText
                title="Address"
                id="producerAddress"
                ...
                handleChange={e => dispatch({ type: "EditProducer", field: "address", payload: e.currentTarget.value })}
            />
            <TextArea
                title="About"
                id="producerInfo"
                ...
                handleChange={e => dispatch({ type: "EditProducer", field: "info", payload: e.currentTarget.value })}
            />
        </CoffeeSection>
    )
};
