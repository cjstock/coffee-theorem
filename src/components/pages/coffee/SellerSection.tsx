    ...
    return (
        <CoffeeSection title={title} description={description}>
            <InputText
                ...
                handleChange={(e) => dispatch({ type: "EditSeller", field: "name", payload: e.currentTarget.value })}
            />
            <InputText
                title="Website"
                id="sellerUrl"
                ...
                handleChange={(e) => dispatch({ type: "EditSeller", field: "url", payload: e.currentTarget.value })}
            />
            <InputText
                title="Address"
                id="sellerAddress"
                ...
                handleChange={(e) => dispatch({ type: "EditSeller", field: "address", payload: e.currentTarget.value })}
            />
            <TextArea
                title="About"
                id="sellerInfo"
                ...
                handleChange={(e) => dispatch({ type: "EditSeller", field: "info", payload: e.currentTarget.value })}
            />
            <Checkbox
