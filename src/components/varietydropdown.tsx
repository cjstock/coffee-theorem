...
const VarietyDropDown = ({ title, data }: VarietyDropDownProps) => {
  ...
  return (
    <>
      <div
        tabIndex={0}
        className={`collapse collapse-arrow rounded-box w-full ${
      ...
      >
        ...
        >
          <div className="collapse-title bg-secondary">{title}</div>
        </button>
          ...
          {data.map((variety) => {
            return (
              <>
                <div
                  key={variety.id}
                  className="p-3 mt-3 border-2 rounded-box border-accent-content"
                >
                      ...
                      <tbody>
                        <tr>
                          {variety.qualPotHighAlt ? (
                            <td>
                              {qualities.QualPotHighAlt[variety.qualPotHighAlt]}
                            </td>
                          ) : null}
                          {variety.yieldPot ? (
                            <td>
                          ...
                          {variety.yearOfFirstProd ? (
                            <td>
                              {qualities.YearFirstProd[variety.yearOfFirstProd]}
                            </td>
                          ) : null}
                        </tr>
                      </tbody>
